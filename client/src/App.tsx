  ...
  const quizQuestions = [
    {
      ...
      options: ["Eat out", "Watch movies", "Go shopping", "Take photos"],
      correct: 0
    },
    {
      question: "Who is most likely to arrive late?",
      options: ["Friend A", "Friend B", "Friend C", "All of us"],
      correct: 3
    },
    {
      question: "What is our go-to hangout spot?",
      options: ["Coffee shop", "Mall", "Park", "Someone's house"],
      correct: 0
    },
    {
      question: "Which describes our friendship best?",
      options: ["Crazy and Fun", "Chill and Relaxed", "Adventurous", "All of the above!"],
      correct: 3
    },
    {
